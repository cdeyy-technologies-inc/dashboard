...
I have retrieved the content from the Next.js tutorial and formatted it into well-structured markdown for you. The content covers creating layouts and pages using the App Router.
...
The `<Layout />` component receives a `children` prop. This child can either be a page or another layout. In your case, the pages inside `/dashboard` will automatically be nested inside a `<Layout />` liko so

![Alt text](./shared-layout.avif "dashboard layout")
...
![Alt text](./shared-layout-page.avif "dashboard pages")

One benefit of using layouts in Next.js is that on navigation, only the page components update while the layout won't re-render. This is called **partial rendering** which preserves client-side React state in the layout when transitioning between pages .

![Alt text](./partial-rendering-dashboard.avif "partial rending dashboard")
...
**Next Up:** 5: Navigating Between Pages - Learn how to navigate between dashboard pages using the `<Link>` component .